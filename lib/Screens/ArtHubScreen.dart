...
/// The screen for displaying artworks and filtering them by tags.
          ...
          children: [
            ...
            Consumer<TagProvider>(
              builder: (context, tagProvider, child) {
                ...
                var noSelection =
                    tagProvider.selectedTag == TagProvider.noSelection;
                      ...
                      builder: (context, value, child) {
                        var matching = details
                            .where((element) => element.tags.any(
                                (tag) => tag.tag == value.selectedTag?.tag))
                            .toList();
                        return RefreshIndicator(
                          ...
                          onRefresh: () async {
                            ...
                            Provider.of<TagProvider>(context, listen: false)
                                .selectTag(TagProvider.noSelection);
                          },
                        );
                      },
                    );
