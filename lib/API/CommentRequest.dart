...
class CommentRequest{
  ...
  static Future<List<CommentModel>> getRelatedComments(int artwork_id) async {
    Map<String, dynamic> data = await ApiManager.fetchData(toString(Endpoint.GET_COMMENT) + artwork_id.toString());
